            ...
            <div class="container">
                ...
                <article class="single-vehicle-details">
                    <div class="single-vehicle-title">
                        ...
                        <h2 class="post-title">{{ $product->name_english }}</h2>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="single-listing-images">
                                <div class="featured-image format-image">
                                    <a href="{{ asset('img/products') }}/{{ $product->image }}" data-rel="prettyPhoto[gallery]" class="media-box"><img src="{{ asset('img/products') }}/{{ $product->image }}" alt="{{ $product->name_english }}"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
